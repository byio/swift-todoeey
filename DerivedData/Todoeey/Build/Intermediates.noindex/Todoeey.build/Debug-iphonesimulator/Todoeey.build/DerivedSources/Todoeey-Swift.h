...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Todoeey",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Todoeey11AppDelegate")
...
SWIFT_CLASS("_TtC7Todoeey8Category")
@interface Category : RealmSwiftObject
@property (nonatomic, copy) NSString * _Nonnull name;
@property (nonatomic, copy) NSString * _Nonnull cellColorHex;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
